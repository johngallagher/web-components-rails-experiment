class ComponentUpdatesController < ApplicationController
  def show
    ...
    response_stuff = {
      ...
      replacements: components_to_reload.map { |component| { replace: component, with_content: render_to_string(partial: "components/#{component}") } }
    }
    render json: response_stuff
  end
end
